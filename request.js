...
function requestadbuttonClicked(){
  ...
  if(randomNumberHolder.textContent == 1){
    ...
    adDisplayContainer.style.backgroundImage = "url('https://cdn.shopify.com/shopifycloud/brochure/assets/online/app-store@mobile-20feca8569d8e896a64dba797faff1cc98becd1b92ebe44d3e993df4fc59033e.png')"
  }
  ...
  else if(randomNumberHolder.textContent == 4){
    adDisplayContainer.style.backgroundImage = "url('https://25174313.fs1.hubspotusercontent-eu1.net/hub/25174313/hubfs/assets_singsaver/forex-trading.jpg?width=680&name=forex-trading.jpg')"
  }
  else if(randomNumberHolder.textContent == 5){
    adDisplayContainer.style.backgroundImage = "url('https://www.gannett-cdn.com/-mm-/2c66e9fa6eb290e62bf7cbc6010f40bfdafd2f07/c=0-416-7952-4889/local/-/media/2022/10/05/USATODAY/usatsports/stock-market-analytics-tablet_TlswVXo.jpg?width=2400&height=1350&fit=crop&format=pjpg&auto=webp')"
  }
  else if(randomNumberHolder.textContent == 6){
    adDisplayContainer.style.backgroundImage = "url('https://cdn.shopify.com/shopifycloud/brochure/assets/online/app-store@mobile-20feca8569d8e896a64dba797faff1cc98becd1b92ebe44d3e993df4fc59033e.png')"
  }
  else if(randomNumberHolder.textContent == 7){
    adDisplayContainer.style.backgroundImage = "url('https://25174313.fs1.hubspotusercontent-eu1.net/hub/25174313/hubfs/assets_singsaver/forex-trading.jpg?width=680&name=forex-trading.jpg')"
  }
...
function adOpened(){
  ...
  if(randomNumberHolder.textContent == 1){
    window.open("https://www.amazon.com/stores/page/8C843987-4C54-424A-9B9C-8DEAB681CC49", "_blank", 'noreferrer')
  }
  else if(randomNumberHolder.textContent == 2){
    window.open("https://onlineforextipsclicks.blogspot.com/2022/11/make-money-with-shopify-make-money-with.html", "_blank", 'noreferrer')
  }
  else if(randomNumberHolder.textContent == 3){
    window.open("https://www.nissan-global.com/EN/", "_blank")
  }
  else if(randomNumberHolder.textContent == 4){
    window.open("https://onlineforextipsclicks.blogspot.com/2022/11/forex-trading-secrets-how-to-make-huge.html", "_blank", 'noreferrer')
  }
  else if(randomNumberHolder.textContent == 5){
    window.open("https://onlineforextipsclicks.blogspot.com/2022/11/truth-about-affliate-marketing-they.html", "_blank", 'noreferrer')
  }
  else if(randomNumberHolder.textContent == 6){
    window.open("https://onlineforextipsclicks.blogspot.com/2022/10/5-ways-to-make-money-on-shopify-5-ways.html", "_blank", 'noreferrer')
  }
  else if(randomNumberHolder.textContent == 7){
    window.open("https://onlineforextipsclicks.blogspot.com/2022/10/5-quick-actions-you-can-do-today-that.html", "_blank", 'noreferrer')
  }
